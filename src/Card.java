public class Card {
	...
	public static Card forString(String splitResult) {
		CardColors color = CardColors.parseColor(splitResult.charAt(1));
		CardFigures figure = CardFigures.parseFigure(splitResult.charAt(0));
